...
#define MPU6050						
//定义驱动部分,移植到STM32F4
#define MOTION_DRIVER_TARGET_STM32F407		
 ...
 * min(int a, int b)
 */
#if defined MOTION_DRIVER_TARGET_STM32F407

#define i2c_write(a,b,c,d)   BoardMPU6050_WriteBuffer(b,d,c)
#define i2c_read(a,b,c,d)    BoardMPU6050_ReadBuffer(b,d,c)
#define delay_ms    CoreDelayMs
